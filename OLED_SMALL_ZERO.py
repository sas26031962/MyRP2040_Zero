...
displayText(text2 + digits,(0,8),clear_oled=False,show_text=True)

displayText(text3 + digits,(0,16),clear_oled=False,show_text=True)

displayText(text4 + digits,(0,24),clear_oled=False,show_text=True)
